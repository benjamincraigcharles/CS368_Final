...
void drawBoard(string playerOne, string playerTwo) {
    ...
    if (game != 0) { 
        ...
        if(game == 0) {
            updateBoard(); 
            cout << "Congratulations " << playerTwo << ", you won!\n";
            cout << "Thank you for playing Connect Four!" << endl;
        } else 
            cout << endl;
    } else {
        updateBoard();
        cout << "Congratulations " << playerOne << ", you won!\n";
        cout << "Thank you for playing Connect Four!" << endl;
    }
}
...
void drawBoard(string playerOne) {
    ...
    if (game != 0) {
        ...
        if (game == 0) {
            cout << endl;
            updateBoard();
            cout << "Sorry " << playerOne << ", the computer won!\n";
            cout << "Thank you for playing Connect Four!" << endl;
       } else  
            cout << endl;
    } else {
...
void p2CompChoice(string choice2) {
    ...
    if(choice2 == "C1") {
        if(r1Loc == -1) {
            ...
            cout << "The computer's choice: " << choice2;
            r1.at(r1Loc) = "OO";
            r1Loc--;
        }
